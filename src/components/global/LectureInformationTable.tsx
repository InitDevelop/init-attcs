    ...
    <table className='subjectpopup-table'>
      <tbody>
        <tr>
          ...
          <td>
            <h4 className='key'>과목명</h4>
            <h4 className='value'>{lect.subjectID} ({lect.lectureID})</h4>
          </td>
        </tr>
        <tr>
          <td>
          ...
          <td>
            ...
            <h4 className='value'>{lect.graduate} 과정</h4>
          </td>
          <td>
        ...
        <tr>
          ...
          <td>
            ...
            <h4 className='value'>{lect.lectureForms}</h4>
          </td>
          <td>
          ...
          <td>
            ...
            <h4 className='value'>{lect.lectureRooms}</h4>
          </td>
        </tr>
        <tr>
          <td colSpan={4}>
