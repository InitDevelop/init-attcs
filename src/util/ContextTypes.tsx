...
import { Lecture, blankLecture } from "./Lecture";
import { LectureGroup } from "./LectureGroup";
import { Scenario } from "./Scenario";
import { Dictionary, NumberPair } from "./Util";
...
export type previewContextTypes = {
  ...
  setTooltipPosition: (param: NumberPair) => void;
...
export type creationContextTypes = {
  ...
  customLectures: CustomLecture[];
  setCustomLectures: (param: CustomLecture[]) => void;
...
export const defaultPreviewContext = {
  ...
  setTooltipPosition: function (param: NumberPair): void {
    throw new Error('Function not implemented.');
  },
  tooltipContent: <></>,
...
export const defaultCreationContext = {
  ...
  customLectures: [],
  setCustomLectures: function (param: CustomLecture[]): void {
    throw new Error('Function not implemented.');
  },
